...
The current source version is CC Quota 0.5.14. The package manifest, package lock, Tauri manifest,
Cargo manifest, and a release tag must match exactly.
...
For a tagged build, `npm run check:version -- v0.5.14` must also pass.
