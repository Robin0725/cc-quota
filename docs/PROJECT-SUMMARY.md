...
CC 0.3.12 is a Tauri 2 macOS menu bar utility that reads existing local Codex Desktop and Claude Code sign-in state and queries each provider's quota service.
