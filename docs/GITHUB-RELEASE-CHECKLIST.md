...
- The app is manually smoke-tested on macOS: left-click 5-hour/weekly toggle, right-click menu, provider capsules, floating-window show/hide, click-to-expand/collapse, drag, screen-edge placement, and stale-data behavior.
