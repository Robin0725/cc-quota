...
export const copy = {
  "zh-CN": {
    ...
    active: "正在消耗额度",
    availableLabel: (percent: number, kind: "short" | "weekly") => `${kind === "short" ? "5 小时" : "周"}额度剩余 ${percent}%`,
    clauseSeparator: "，",
    controls: "悬浮窗控制",
    ...
    weeklyFallback: "当前账号未返回 5 小时窗口，正在显示周额度",
    weeklyUntil: (date: string) => `本周剩余 · 至 ${date}`,
  },
  en: {
    accountFallback: "ACCOUNT",
    active: "Quota in use",
    availableLabel: (percent: number, kind: "short" | "weekly") => `${kind === "short" ? "5-hour" : "Weekly"} quota remaining ${percent}%`,
    clauseSeparator: ", ",
    controls: "Floating widget controls",
    expandDetails: "click for details",
    ...
    lock: "Lock and enable click-through",
    ...
    weeklyFallback: "No 5-hour window was returned, so weekly quota is shown",
