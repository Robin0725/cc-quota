...
- Keeps retrying with a capped backoff while Kimi stays focused but its quota snapshot is unavailable, covering credentials renewed without another focus transition.
